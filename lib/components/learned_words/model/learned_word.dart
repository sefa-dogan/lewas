...
class LearnedWord {
  ...
  factory LearnedWord.fromMap(Map<String, dynamic> map) {
    return LearnedWord(
      ...
      meanings: List<Meaning>.from((map['meanings'] as List<dynamic>).map<Meaning>((x) => Meaning.fromMap(x as Map<String,dynamic>),),),
    );
  }

  String toJson() => json.encode(toMap());

  factory LearnedWord.fromJson(String source) => LearnedWord.fromMap(json.decode(source) as Map<String, dynamic>);
